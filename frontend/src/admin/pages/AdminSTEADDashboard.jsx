/**
 * Admin STEAD Dashboard Page
 * 
 * Admin dashboard for STEAD anomaly detection features.
      ...
      <div className="min-h-screen bg-[#EAECFF] p-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <Link to="/admin/stead/rtsp-live" className="block group">
            ...
            {/* Video Upload */}
            <Link to="/admin/stead/video-upload" className="block group">
              <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-[#6966FF]">
                <div className="flex items-start gap-4">
...
export default AdminSTEADDashboard;
